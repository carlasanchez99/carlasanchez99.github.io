---
title: "BACHMI DIABLO genes M0 (high vs low) vs datasets D-1"
...
## 1. DIABLO between DEG M0 high vs low responders & datasets at D-1
...
rownames(genest)<-gsub("M0", "D-1",rownames(genest))
...
## 2. Correlations DEG M0 & Cytokines D-1 DIABLO circ >0.8.
...
## 4. Correlations DEG M0 & Antibodies D-1 DIABLO circ >0.8.
...
## 4. Correlations DEG M0 & DC D-1 DIABLO circ >0.8.

```{r, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.height=20, fig.width=29}

plot<-create_plot("CD86+ mDC", circ, genest, dcdiablo, gem.cli.df, "dcdiablo")
print(plot$plot)

```

## 5. Correlations DEG M0 & Hemo D-1 DIABLO circ >0.8.

```{r, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.height=10, fig.width=35}
plot<-create_plot("whitecell", circ, genest, hemodiablo, gem.cli.df, "hemodiablo")
print(plot$plot)
```

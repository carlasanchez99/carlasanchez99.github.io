---
title: "BACHMI DIABLO GENESETS M0 (high vs low) vs datasets D-1"
...
## 1. DIABLO between genesets M0 high vs low responders & datasets at D-1
...
rownames(btmsdiablo)<-gsub("M0", "D-1",rownames(btmsdiablo))
...
## 2. Correlations Genesets M0 & Cytokines D-1 DIABLO circ >0.8.
...
## 4. Correlations Genesets M0 & Antibodies D-1 DIABLO circ >0.8.
...
## 4. Correlations Genesets M0 & DC D-1 DIABLO circ >0.8.

```{r, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=15}

plot<-create_plot("PD1L+ pDC", circ, btmsdiablo, dcdiablo, gem.cli.df, "dcdiablo")
print(plot$plot)

```

## 5. Correlations Genesets M0 & Hemo D-1 DIABLO circ >0.8.

```{r, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.height=15, fig.width=35}
plot<-create_plot("Lymphocytes", circ, btmsdiablo, hemodiablo, gem.cli.df, "hemodiablo")
print(plot$plot)
